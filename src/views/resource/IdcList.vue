<template>
  <div class="user-list-container">
    ...
    <!-- 添加机房开始 -->
    <el-dialog title="添加机房" :visible.sync="isFormVisible">
        <el-form ref="addForm" :model="addForm" label-width="80px" :rules="addRule">
            <el-form-item label="机房名称" prop="name">
                <el-input v-model="addForm.name" maxlength=15 placeholder="请输入机房名称"></el-input>
            </el-form-item>
            <el-form-item label="字母简称" prop="letter">
                <el-input v-model="addForm.letter" maxlength=20 placeholder="请输入字母简称"></el-input>
            </el-form-item>
    ...
    <!-- /结束 -->
    <!-- 修改IDC开始 -->
    <el-dialog title="修改机房信息" :visible.sync="isEditFormVisible">
        <el-form ref="editForm" :model="editForm" label-width="80px" :rules="addRule">
            <el-form-item label="机房名称" prop="name">
                <el-input v-model="editForm.name" maxlength=15 placeholder="请输入机房名称"></el-input>
            </el-form-item>
            <el-form-item label="字母简称" prop="letter">
                <el-input v-model="editForm.letter" maxlength=20 placeholder="请输入字母简称"></el-input>
            </el-form-item>
            <el-form-item label="联系电话" prop="tel">

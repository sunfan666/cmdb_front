  ...
  <div class="user-list-container">
    ...
    <el-dialog title="添加机柜" :visible.sync="isFormVisible">
        <el-form ref="addForm" :model="addForm" label-width="80px" :rules="addRule">
            ...
            <el-form-item label="机柜简称" prop="letter">
              <el-input v-model="addForm.letter" maxlength=20 placeholder="请输入简称"></el-input>
            </el-form-item>
    ...
    <el-dialog title="修改机柜" :visible.sync="isEditFormVisible">
        <el-form ref="editForm" :model="editForm" label-width="80px" :rules="addRule">
            ...
            <el-form-item label="机柜简称" prop="letter">
                <el-input v-model="editForm.letter" maxlength=20 placeholder="请输入简称"></el-input>
            </el-form-item>
            <el-form-item label="所在机房" prop="idc">
...
export default {
  ...
  methods: {
    ...
    editClick(row) {
      ...
      const { id, name, letter, power_supply } = row
      const { idc } = { idc: row.idc.id }
      this.editForm = { id, name, power_supply, letter, idc }
